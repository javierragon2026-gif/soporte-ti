    ...
    <div class="container-fluid py-4 px-md-5">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 pb-2 border-bottom">
            <div>
                ...
                <p class="text-muted mb-0">Bienvenido de nuevo, <span class="fw-semibold"
                        style="color: #F4A637;">{{ auth()->user()->name ?? 'Agente' }}</span></p>
            </div>
            <div class="mt-3 mt-md-0">
                <a href="{{ route('cliente.tickets.crear') }}" class="btn text-white px-4 py-2 shadow-sm"
                    style="background-color: #F4A637; border-radius: 8px; font-weight: 600;">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card border-0 shadow-sm h-100"
                    style="background: #ffffff; border-radius: 12px; border-left: 5px solid #F4A637 !important;">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card border-0 shadow-sm h-100"
                    style="background: #ffffff; border-radius: 12px; border-left: 5px solid #e74c3c !important;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card border-0 shadow-sm h-100"
                    style="background: #ffffff; border-radius: 12px; border-left: 5px solid #67768A !important;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <span class="badge text-white" style="background-color: #67768A; font-size: 0.75rem;">En
                                seguimiento</span>
                        </div>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card border-0 shadow-sm h-100"
                    style="background: #ffffff; border-radius: 12px; border-left: 5px solid #2ecc71 !important;">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm" style="border-radius: 12px; overflow: hidden;">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('tickets.index') }}" class="btn btn-sm btn-link text-decoration-none fw-semibold"
                            style="color: #F4A637;">
                ...
                <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; background: #ffffff;">
                    ...
                    <div class="card-body">
                        <div class="p-3 mb-3 rounded" style="background-color: #FFF8F0; border: 1px solid #FFDCA8;">
                            ...
                            <p class="small text-muted mb-0">Horario operativo: 08:00 - 18:00 hrs. Los tickets creados
                                fuera de horario pasan a cola automática.</p>
                        </div>
