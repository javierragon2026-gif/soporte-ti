...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('tickets.create') }}" class="btn text-white" style="background-color: #F4A637; font-weight: 600;">
                    ...
                    <tbody>
                        @forelse($tickets as $ticket)
                            <tr>
                                ...
                                <td class="text-muted" style="font-size: 0.85rem;">{{ $ticket->created_at?->format('d/m/Y H:i') }}</td>
