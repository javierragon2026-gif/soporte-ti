@if ($ticket->canBeEdited())
    ...
    <div class="mt-4 p-4 bg-white shadow-sm border-start border-4 mb-4"
        style="border-radius: 12px; border-color: #F4A637 !important;">
        ...
        <form method="POST" action="{{ route('comments.store', $ticket) }}" enctype="multipart/form-data"
            ...
            <textarea id="comment-text-area" name="body" class="form-control bg-light border-0 mb-3 shadow-sm" rows="4"
                placeholder="Escribe aquí tu actualización del caso..." required>
...
@endif
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                @if ($ticket->isEscalated())
                    <button type="submit" class="btn text-white fw-bold shadow-sm px-4"
                        style="background-color: #e74c3c; border-radius: 8px;">
